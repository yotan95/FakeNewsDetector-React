                ...
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="pe-2">
                                <div class="chart">
                                    <canvas id="chart-bars" class="chart-canvas" style={{ display: "block", boxSizing: "border-box", height: "170px", width: "328px" }}></canvas>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card ">
                        <div class="card-body">
                            ...
                            <div class="pe-2">
                                <div class="chart">
                                    <canvas id="chart-line" class="chart-canvas" style={{ display: "block", boxSizing: "border-box", height: "170px", width: "328px" }}></canvas>
                                </div>
                            </div>
                            <hr class="dark horizontal" />
                            <div class="d-flex ">
                ...
                <div class="col-lg-4 mt-4 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="pe-2">
                                <div class="chart">
                                    <canvas id="chart-line-tasks" class="chart-canvas" style={{ display: "block", boxSizing: "border-box", height: "170px", width: "328px" }}></canvas>
                                </div>
                            </div>
                            <hr class="dark horizontal" />
                            <div class="d-flex ">
