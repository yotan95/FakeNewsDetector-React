...
export const BoardModify = () => {
    ...
    const handleModifyClick = (e) => {
        e.preventDefault();
        // const response = modifyBoard(boardDate);
    };
            ...
            <div className="boardwr-group">
                <form className="boardwr-frame">
                    ...
                    <div className="boardwr-frame-5">
                        ...
                        <input className="boardwr-rectangle" type="text" placeholder="제목을 입력하세요." required value={title}></input>
                    </div>
                    {/* 이미지 업로드 */}
                    {/* <div className="boardwr-frame-5">
                    ...
                    <div className="boardwr-frame-6">
                        ...
                        <textarea className="boardwr-rectangle-2" required value={content}></textarea>
                    </div>
                    <div className="boardwr-frame-7">
                        <div className="boardwr-frame-8">
                            <div className="boardwr-text-wrapper-7">게시글 비밀번호 설정</div>
                            <div className="boardwr-div-wrapper"><input className="boardwr-rectangle-3" type="password" value={password}></input></div>
